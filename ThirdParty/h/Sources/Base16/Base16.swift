...
public enum Base16 {
    ...
    @inlinable public static func encode<Digits>(
...
extension Base16 {
    ...
    /// Characters (including UTF-8 continuation bytes) that are not base-16 digits
    /// will be skipped.
    @inlinable public static func decode<ASCII>(
        _ ascii: ASCII,
    ...
    @inlinable public static func encode<BigEndian, Digits>(
...
extension Base16 {
    ...
    @inlinable public static func decode<BigEndian>(
        _ ascii: some Sequence<UInt8>,
        loading _: BigEndian.Type = BigEndian.self
    ) -> BigEndian? {
